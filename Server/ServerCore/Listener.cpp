...
void Listener::ProcessAccept(AcceptEvent* acceptEvent)
{
	...
	if (SOCKET_ERROR == ::getpeername(session->GetSocket(),OUT reinterpret_cast<SOCKADDR*>(&socketAddress),&sizeOfSockAddr))
	{
		RegisterAccept(acceptEvent);
		return;
	}

	session->SetNetAddress(NetAddress(socketAddress));
